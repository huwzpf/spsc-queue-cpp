...
public:
    ...
    simple_spsc_queue(const simple_spsc_queue &) = delete;
    simple_spsc_queue &operator=(const simple_spsc_queue &) = delete;
    simple_spsc_queue(simple_spsc_queue &&) = delete;
    simple_spsc_queue &operator=(simple_spsc_queue &&) = delete;
